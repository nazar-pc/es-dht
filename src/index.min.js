...
t>m&&(v.i(r),p=!0)}if(!p)break}this.g.set(a,[h,v,b]);return l},update_lookup:function(a,b,f,g){var e;var c=this.g.get(a);if(!c)return[];var d=c[0];var k=c[1];var l=c[2];d["delete"](b);if(!g)return k.i(b),[];c=u();var m=0;for(e=g.length;m<e;++m){var h=g[m];!k.has(h)&&k.set(h)&&c.add(h)}a=k.closest(a,l);g=[];m=0;for(e=a.length;m<e;++m)k=a[m],c.has(k)&&(g.push([k,b,f]),d.add(k));return g},finish_lookup:function(a){var b=this.g.get(a);this.g["delete"](a);return this.a.has(a)?[a]:b?b[1].closest(a,b[2]):
